...
def charactertrajectories_visualize(dataset, type, save):
...
def visualize_latent_space(config, test_ds, save):
    ...
    if save:
        save_name = "visualizations/charactertrajectories/embeddings.pdf"
...
def visualize_single_variable_prototypes(config, test_ds, save):
    ...
    with torch.no_grad():
        ...
        classes_with_prototype = classes + [20]
    ...
    if save:
        save_name = "visualizations/charactertrajectories/single_variable_prototypes.pdf"
        plt.savefig(save_name, dpi=300)
    plt.show()
...
def visualize_multivariable_prototypes(config, save):
    ...
    if save:
        save_name = "visualizations/charactertrajectories/multivariable_prototypes.pdf"
        plt.savefig(save_name, dpi=300)
    plt.show()
