...
if __name__ == "__main__":
    ...
    #                     (0.1)*prototype_similarity_penalty_term +    \
    ...
    #     if epoch % 10 == 0:
    #         print(classification_loss, prototype_similarity_penalty_term)
    #         print(encoded_space_coverage_penalty_term, prototype_diversity_penalty_term)
    #         with torch.no_grad():
    #             numerator = 0
    #             denominator = 0
    #             for train, label in data_train:
