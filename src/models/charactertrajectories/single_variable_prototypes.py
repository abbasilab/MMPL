...
if __name__ == "__main__":
    ...
    encoding_module.load_state_dict(torch.load("models/charactertrajectories/enc.dat"))

    sv_modules_wrapper = SingleVariableModulesWrapper(num_variables=3, num_classes=4, hidden=10, num_prototypes=14)
    ...
    #             out = torch.concat([out, len(class_to_index)*torch.ones((sv_modules_wrapper.single_variable_modules[i].protolayer.prototype_matrix.shape[0],))], dim=0)
